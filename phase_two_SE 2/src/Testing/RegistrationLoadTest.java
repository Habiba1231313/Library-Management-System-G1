...
public class RegistrationLoadTest implements JavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext context) {
        ...
        try {
            // Create dummy membership application
            ...
            if (card != null) {
                ...
                result.setResponseMessage("Registration succeeded for: " + name);
    ...
    public Arguments getDefaultParameters() {
        return new Arguments(); // no parameters required
    }
}
